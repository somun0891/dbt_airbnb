!(function (e) {
  function t(t) {
    for (
      var i, r, s = t[0], l = t[1], d = t[2], u = 0, f = [];
      u < s.length;
      u++
    )
      (r = s[u]),
  ...
  168: function (e, t, n) {
    ...
    var o,
      ...
      s = function () {
        if (o) return o;
        var e = window.__config___ || {};
        return (o = (0, r.merge)(a.default, e));
      };
    t.t = function (e) {
      var t = s();
      return (0, r.get)(t, e) || "";
    ...
    var x = (function (e) {
      ...
      function i(e) {
        ...
        return (
          (0, a.default)(this, i),
          (t = n.call(this, e)),
          (0, f.default)((0, s.default)(t), "_precollide", function (e, t, n) {
            var i,
              o = {},
              a = [],
              r = {},
            ...
            try {
              for (s.s(); !(i = s.n()).done; ) {
                var l = i.value;
                o[l.left] || (o[l.left] = []), o[l.left].push(l);
              }
            } catch (e) {
              s.e(e);
            } finally {
            ...
            (a = Object.keys(o).sort(function (e, t) {
            ...
            a.forEach(function (e) {
              ...
              for (var a = 0; a < i.length; a++)
                d[e] = Math.max(d[e], i[a].left + i[a].width + n);
              if (1 !== i.length) {
                ...
                for (var r = 0; r < i.length - 1; r++) {
                  var s = i[r],
                    l = i[r + 1];
                  s.top + s.height >= l.top && (l.top = s.top + s.height + t),
                    s.top + s.height + t < l.top &&
                      (l.top = s.top + s.height + t);
                }
              }
            });
            for (
          ...
          (t._renderPromise = Promise.resolve()),
          (t._focusItem = null),
          (t._enableHoverChain = e.data.enableHoverChain),
          t.attachEvent(),
          t
        );
      }
        ...
        (0, r.default)(i, [
          {
            ...
            value: function () {
              var e = this;
              this._enableHoverChain &&
                (this.on("custom.field.hover", function (t) {
                  e.focusChain(t.node.id, t.fieldId, "hover-chain");
                }),
                this.on("custom.field.unHover", function (t) {
                  e.unfocusChain(t.node.id, t.fieldId, "hover-chain");
                })),
                this.on("custom.edge.redraw", function (t) {
                  var n = t.node,
                    i = t.points,
                    o = [];
                  i
                    ? i.forEach(function (t) {
                        o = o.concat(e.getNeighborEdgesByEndpoint(n.id, t.id));
                      })
                    : (o = e.getNeighborEdges(n.id)),
          ...
          },
          {
            ...
            value: function (e) {
              this.unfocus();
              var t = (this._focusItem = this.getNode(e));
              t && t.focus();
            },
          },
          {
            ...
            value: function () {
              this._focusItem &&
                (this._focusItem.unfocus(), (this._focusItem = null));
            },
          },
          {
            key: "focusChain",
            value: function (e, t, n) {
              var i = this._findChain(e, t);
              i.edges.forEach(function (e) {
                e.focusChain(n);
              }),
                i.fileds.forEach(function (e) {
                  (0, p.default)(e).addClass(n);
                });
            },
          },
          {
            ...
            value: function (e, n) {
              for (
                var i = this,
                  o = [],
                  a = [],
                  r = [{ nodeId: e, fieldId: n, type: "both" }],
                  s = function () {
                    var e = r.pop(),
                      n = i.getNode(e.nodeId);
                    if (n.options.isCollapse) return "continue";
                    var s = h.find(n.fieldsList, function (t) {
                      return t.id === e.fieldId;
                    });
                    a.push(s.dom);
                    var l = i.getNeighborEdges(n.id);
                    t.getEdges = j = function (e) {
                      return i.getNeighborEdges(e);
                    };
                    var d = [],
                      c = [];
                    ("both" !== e.type && "source" !== e.type) ||
                      (d = l.filter(function (t) {
                        return (
                          t.options.sourceNode === n.id &&
                          t.options.source === "".concat(e.fieldId, "-right")
                        );
                      })),
                      ("both" !== e.type && "target" !== e.type) ||
                        (c = l.filter(function (t) {
                          return (
                            t.options.targetNode === n.id &&
                            t.options.target === "".concat(e.fieldId, "-left")
                          );
                        })),
                      (o = o.concat(d).concat(c)),
                      d.forEach(function (e) {
                        r.push({
                          nodeId: e.options.targetNode,
                          fieldId: e.options.target.replace("-left", ""),
                          type: "source",
                        });
                      }),
                      c.forEach(function (e) {
                        r.push({
                          nodeId: e.options.sourceNode,
                          fieldId: e.options.source.replace("-right", ""),
                          type: "target",
                        });
                      });
                  };
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              a = t
                ? e.edges || []
                : i.map(function (e) {
                    return { source: e.sourceNode.id, target: e.targetNode.id };
                  });
              m.Layout.dagreLayout({
                rankdir: "LR",
                nodesep: 50,
                ranksep: 70,
                data: { nodes: o, edges: a },
              }),
                this._precollide(o, 50, 70),
                e && e.centerNodeId && this._fixCenterNode(o, e.centerNodeId),
                !t &&
                  i.length > 30 &&
                  (0, p.default)(this.svg).css("visibility", "hidden"),
                this.nodes.forEach(function (e, t) {
                  var n = o[t].left,
                    i = o[t].top;
                  (e.top === i && e.left === n) ||
                    ((e.options.top = i), (e.options.left = n), e.moveTo(n, i));
                }),
                !t &&
                  i.length > 30 &&
                  (0, p.default)(this.svg).css("visibility", "visible");
            },
          },
          {
            key: "addNodes",
  ...
  337: function (e, t, n) {
    "use strict";
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.setDragedPosition = t.setElementDragable = void 0);
    var i,
      o = new Map(),
      a = function (e) {
        i = e;
      };
    t.setElementDragable = function (e, t) {
      var n = !1,
        r = !1,
        s = 0,
        l = 0,
      ...
      e.addEventListener("mousedown", function (t) {
        (n = !0),
          ...
          (d = 0),
          (c = 0),
          (u = Number(e.style.top.replace("px", "")) || 0),
          (f = Number(e.style.left.replace("px", "")) || 0),
          o.get(e) || o.set(e, { top: u, left: f });
      }),
        ...
        document.addEventListener("mousemove", function (t) {
          (r = !0),
            n &&
              ...
              (d = t.clientX - s),
              (c = t.clientY - l),
              (e.style.top = "".concat(u + c, "px")),
              (e.style.left = "".concat(f + d, "px")));
        });
    };
    function r(e) {
      var t = e.getBoundingClientRect(),
        ...
        o = t.width,
        a = t.height;
      return { x: i + o / 2, y: n + a / 2, height: a, width: o };
    }
    t.setDragedPosition = function (e, t, n) {
      var i,
        o,
        a,
        s = ((i = e), (o = r(t)), (a = r(i)), { x: o.x - a.x, y: o.y - a.y }),
        l = s.x,
        d = s.y,
        ...
        f = c.height;
      return (
        (n.pos[1] = e.offsetTop + d + f / 2),
        (n.pos[0] = e.offsetLeft + l + u / 2 - 15),
        n
      );
    };
  },
    ...
    var b = n(571),
      ...
      w = (function (e) {
        function t(t) {
          ...
          return (
            (n.state = {
              sql: u.default.createElement(u.default.Fragment, null),
              allCollapse: !1,
              tables: [],
              sourceTable: [],
              relations: [],
              ...
              actionMenu: [
                {
                  icon: u.default.createElement(b.StarOutlined, null),
                  key: "star",
                  title: "select",
                  onClick: function () {
                ...
                {
                  icon: u.default.createElement(b.ShrinkOutlined, null),
                  key: "expand",
                  title: "expand all",
                  onClick: function () {
                    n.state.tables.forEach(function (e) {
                      e.isCollapse = !!n.state.allCollapse;
                    }),
                      n.setState({
                        tables: d([], n.state.tables, !0),
                        allCollapse: !n.state.allCollapse,
                      });
                  },
                },
                {
                  icon: u.default.createElement(b.RetweetOutlined, null),
                  key: "explore",
                  title: "explore all",
                  onClick: function () {
                    if (n.state.initTable) {
                      var e = n.findNode(n.state.initTable, !0),
                        t = [n.state.initTable.id],
                        i = function (e) {
                          e.forEach(function (e) {
                            if (!t.includes(e)) {
                              var o = n.state.tables.find(function (t) {
                                return t.id === e;
                              });
                              t.push(e);
                              var a = n.findNode(o, !0).filter(function (e) {
                                return !t.includes(e);
                              });
                              i(a);
                            }
            ...
            (n.columns = [{ key: "name", primaryKey: !0 }, { key: "title" }]),
            (n.operator = [
              {
                id: "viewSql",
                name: (0, y.t)("viewSql"),
                icon: u.default.createElement(
                  h.Popover,
                  {
                    content: u.default.createElement(
                      "div",
                  ...
                  u.default.createElement(b.ConsoleSqlOutlined, null)
                ),
                onClick: function (e) {
                  var t = n.state.tables.findIndex(function (t) {
                      return t.id === e.id;
                    }),
                    i = n.state.tables[t];
                  setTimeout(function () {
              ...
              },
              {
                ...
                icon: u.default.createElement(
                  h.Tooltip,
                  { title: (0, y.t)("expand") },
                  u.default.createElement(b.BorderOuterOutlined, null)
                ),
                onClick: function (e) {
                  var t = n.state.tables.findIndex(function (t) {
                      return t.id === e.id;
              ...
              },
              {
                ...
                icon: u.default.createElement(
                  h.Tooltip,
                  { title: (0, y.t)("explore") },
                  u.default.createElement(b.DownSquareOutlined, null)
                ),
                onClick: function (e) {
                  n.findNode(e);
                },
        ...
        return (
          ...
          (t.prototype.findNode = function (e, t) {
            var n = this,
              i = this.state.tables.findIndex(function (t) {
                return t.id === e.id;
              }),
              o = this.state.tables[i],
              r = this.state.relations,
              s = o.id,
              l = [];
            r.forEach(function (e) {
              var t;
              e.srcTableId === s &&
                (t = n.state.tables.find(function (t) {
                  return t.id === e.tgtTableId;
                })) &&
                ((t.isExpand = !0),
                (t.isCollapse = !1),
                l.includes(t.id) || l.push(t.id));
              e.tgtTableId === s &&
                (t = n.state.tables.find(function (t) {
                  return t.id === e.srcTableId;
                })) &&
                ((t.isExpand = !0),
                (t.isCollapse = !1),
                l.includes(t.id) || l.push(t.id));
              ...
              (o.isCollapse = !1);
            var c = d([], this.state.tables, !0);
            return (
              this.setState({
                tables: c.map(function (e) {
                  return a(a({}, e), { isCollapse: !0 });
                }),
              }),
              t ||
                setTimeout(function () {
                  n.setState({ tables: c, centerId: o.id });
                }, 1e3),
              l
            );
          }),
          (t.prototype.changeSourceData = function () {
            var e = this,
              t = function (t) {
                var n = new j.AdapterV2().transfer(t),
                  i = n.tables,
                  o = n.relations,
                  a = g.cloneDeep(i),
                  r = i.slice(0, 10).map(function (e) {
                    return e.name;
                  });
                e.setState({
                  tables: i,
            ...
            if ((this.setState({ initTable: void 0 }), this.state.file)) {
              var n = new FileReader();
              n.addEventListener(
                "load",
                function () {
                  try {
                    var e = JSON.parse(n.result.toString());
                    t(e),
                      localStorage.setItem("sourceJSON", n.result.toString());
                  } catch (e) {
                    console.log(e),
                      h.message.error("invalid json file: ".concat(e));
                  }
                },
                !1
              ),
                n.readAsText(this.state.file);
            } else
              try {
                var i = JSON.parse(
                  window.inlineSource || localStorage.getItem("sourceJSON")
                );
                t(i);
              } catch (e) {
                console.log(e), h.message.warn("not init source data");
              }
          }),
          (t.prototype.confirmTable = function () {
            var e = this;
            this.state.tables.forEach(function (e) {
              e.isExpand = !1;
            }),
              (this.state.initTable.isExpand = !0);
            var t = d([], this.state.tables, !0);
            this.setState({
              visible: !1,
              tables: t.map(function (e) {
                return a(a({}, e), { isCollapse: !0 });
              }),
            }),
              setTimeout(function () {
                e.setState({ tables: t, centerId: e.state.initTable.id });
              }, 1e3);
          }),
          (t.prototype.getSelect = function (e) {
            var t,
              n = this,
              i = (0, m.debounce)(function (e) {
                var t = n.state.tables
                  .filter(function (t) {
                ...
                n.setState({ options: t });
              }, 300),
              o = this.state.tables.slice(0, 100).map(function (e) {
                return e.name;
              });
            return u.default.createElement(
              h.Select,
              {
                ...
                value:
                  null === (t = this.state.initTable) || void 0 === t
                    ? void 0
                    : t.id,
                ...
                onDropdownVisibleChange: function (e) {
                  e && n.setState({ options: o });
                },
                onSearch: function (e) {
                  i(e);
                },
                onChange: function (t) {
                  var i = n.state.tables.find(function (e) {
                    return e.name === t;
                  });
                  n.setState({ initTable: i }),
                    setTimeout(function () {
                      e && n.confirmTable();
                    });
                },
          ...
          (t.prototype.getUpload = function () {
            var e,
              t,
              n = this;
            return u.default.createElement(
              ...
              u.default.createElement(
                h.Button,
                { icon: u.default.createElement(b.UploadOutlined, null) },
                (0, y.t)("selectFile"),
                " ",
                (
                  null === (e = this.state.file) || void 0 === e
                    ? void 0
                    : e.name
                )
                  ? ""
                      .concat((0, y.t)("crrFile"))
                      .concat(
                        null === (t = this.state.file) || void 0 === t
                          ? void 0
                          : t.name
                      )
                  : ""
                  ...
                  u.default.createElement(
                    ...
                    u.default.createElement(
                      ...
                      u.default.createElement(
                        h.Dropdown,
                        {
                          overlay: u.default.createElement(
                            "div",
                            null,
                            u.default.createElement(
                              h.Menu,
                              { selectable: !1, className: "menuContainer" },
                              (0, y.t)("headerDropdown").map(function (e) {
                                return u.default.createElement(
                                  h.Popover,
                                  {
                                    placement: "leftTop",
                                    content: u.default.createElement(h.Image, {
                                      src: e.src,
                                      className: "demoImage",
                                    }),
                                  },
                        ...
                        u.default.createElement(
                          h.Button,
                          { type: "primary", style: { marginLeft: "20px" } },
                          (0, y.t)("headerDropdownText")
                        )
                      )
                    ),
                    u.default.createElement(
                      ...
                      u.default.createElement(
                        h.Popover,
                        {
                          ...
                          onVisibleChange: function (t) {
                            return e.setState({ demoImageVisible: t });
                          },
                        },
                        u.default.createElement(
                          h.Button,
                ...
                u.default.createElement(
                  ...
                  u.default.createElement(
                    ...
                    u.default.createElement(v.default, {
                      tables: this.state.tables.filter(function (e) {
                        return e.isExpand;
                      }),
                      ...
                      onLoaded: function (t) {
                        e.setState({ canvas: t }), e.changeSourceData();
                      },
                      config: {
                        titleRender: function (e, t) {
                          return u.default.createElement(
                            u.default.Fragment,
                            null,
                            e
        ...
        return (
          ...
          (t.prototype.componentDidMount = function () {
            var e = this,
              ...
              n = u.get(this.props, "config.enableHoverChain", !0),
              i = u.get(this.props, "config.titleRender"),
              o = {
                root: t,
                disLinkable: !1,
                linkable: !1,
                ...
                theme: {
                  ...
                  endpoint: {
                    limitNum: void 0,
                    expandArea: { left: 0, right: 0, top: 0, botton: 0 },
                  },
                },
                data: { enableHoverChain: n },
              };
            this.canvas = new f.default(o);
            var a = (0, m.transformInitData)({
            ...
            (this.originEdges = a.edges),
              (a = (0, m.transformEdges)(a.nodes, u.cloneDeep(a.edges))),
              (this.canvasData = { nodes: a.nodes, edges: a.edges }),
              setTimeout(function () {
                var t = a.edges;
                (a.edges = []),
                  e.canvas.draw(a, function () {
                    e.canvas.relayout(
                      {
                        edges: t.map(function (e) {
                          return { source: e.sourceNode, target: e.targetNode };
                        }),
                      },
                      !0
                    ),
                      e.canvas.addEdges(t, !0);
                    var n = u.get(e, "props.config.minimap", {}),
                      i = u.assign({}, n.config, {
                        events: ["system.node.click", "system.canvas.click"],
                      });
                    n && n.enable && e.canvas.setMinimap(!0, i),
                      u.get(e, "props.config.gridMode") &&
                        e.canvas.setGridMode(
                          !0,
                          u.assign({}, u.get(e, "props.config.gridMode", {}))
                        ),
                      0 !== a.nodes.length &&
                        (e.canvas.focusCenterWithAnimate(),
                        (e._isFirstFocus = !0)),
                      e.forceUpdate(),
                      e.props.onLoaded && e.props.onLoaded(e.canvas);
                  }),
                  e.canvas.on("system.node.click", function (t) {
                    var n = t.node;
                    e.canvas.focus(n.id);
                  }),
                  e.canvas.on("system.canvas.click", function () {
                    e.canvas.unfocus();
                  });
              }, u.get(this.props, "config.delayDraw", 0));
          }),
          (t.prototype.shouldComponentUpdate = function (e, t) {
            var n = this,
              i = u.get(e, "config.enableHoverChain", !0),
              o = u.get(this.props, "config.titleRender"),
              a = (0, m.transformInitData)({
                tables: e.tables,
            ...
            (this.originEdges = a.edges),
              (a = (0, m.transformEdges)(a.nodes, u.cloneDeep(a.edges)));
            var r = (0, m.diffPropsData)(a, this.canvasData),
              s = !1;
            if (
              (r.rmEdges.length > 0 &&
                (this.canvas.removeEdges(
                  r.rmEdges.map(function (e) {
                    return e.id;
                  })
                ),
                (s = !0)),
              r.rmNodes.length > 0 &&
                this.canvas.removeNodes(
                  r.rmNodes.map(function (e) {
                    return e.id;
                  })
                ),
              r.addNodes.length > 0 && this.canvas.addNodes(r.addNodes),
              r.collapseNodes.length > 0 &&
                (r.collapseNodes.forEach(function (e) {
                  n.canvas.getNode(e.id).collapse(e.isCollapse);
                }),
                (s = !0)),
              r.addEdges.length > 0 &&
                (this.canvas.addEdges(r.addEdges), (s = !0)),
              s)
            ) {
              this.canvas.relayout({ centerNodeId: e.centerId });
              var l = this.canvas.nodes.map(function (e) {
                return e._renderPromise;
              });
              this.canvas._renderPromise = Promise.all(l).then(function () {
                return new Promise(function (t, i) {
                  e.centerId
                    ? (n.canvas.focusNodeWithAnimate(
                        e.centerId,
                        "node",
                        {},
                        function () {
                      ...
                      n.canvas.focus(e.centerId))
                    : (n._isFirstFocus ||
                        (n.canvas.focusCenterWithAnimate(),
                        (n._isFirstFocus = !0)),
                      t());
                });
              });
            ...
            return (
              (this.canvasData = a),
              (0, m.updateCanvasData)(a.nodes, this.canvas.nodes),
              (0, m.diffActionMenuData)(e.actionMenu, this.props.actionMenu)
            );
          }),
          (t.prototype.render = function () {
            var e = this.canvas,
              t = this.props.actionMenu,
              n = void 0 === t ? [] : t,
              i = u.get(this, "props.config.showActionIcon", !0);
          ...
          (t.prototype._genClassName = function () {
  ...
  469: function (e, t, n) {
    ...
    t.transformInitData = function (e) {
      var t = e.tables,
        n = e.relations,
        i = e.columns,
        o = e.emptyContent,
        d = e.operator,
        c = e._titleRender,
        u = e._enableHoverChain,
        f = e._emptyContent,
        m = e._emptyWidth;
      return {
        nodes: t.map(function (e) {
          var t;
          return l.assign(
            ((t = {
              Class: r.default,
            ...
            (0, a.default)(t, "_emptyContent", f),
            (0, a.default)(t, "_emptyWidth", m),
            t),
            e
          );
        }),
        edges: n.map(function (e) {
          return {
            relationColor: e.relationColor,
            id:
              e.id ||
              ""
                .concat(e.srcTableId, "-")
                .concat(e.tgtTableId, "-")
                .concat(e.srcTableColName, "-")
                .concat(e.tgtTableColName),
            type: "endpoint",
            sourceNode: e.srcTableId,
            targetNode: e.tgtTableId,
            source:
              void 0 !== e.srcTableColName && null !== e.srcTableColName
                ? e.srcTableColName
                : e.srcTableId + "-right",
            target:
              void 0 !== e.tgtTableColName && null !== e.tgtTableColName
                ? e.tgtTableColName
                : e.tgtTableId + "-left",
            _isNodeEdge: !(
              (void 0 !== e.srcTableColName && null !== e.srcTableColName) ||
    ...
    t.transformEdges = function (e, t) {
      t.forEach(function (e) {
        e._isNodeEdge || ((e.source += "-right"), (e.target += "-left"));
      }),
        e.forEach(function (e) {
          e.isCollapse &&
            (t
              .filter(function (t) {
                return e.id === t.sourceNode;
              })
              .forEach(function (t) {
                (t.source = "".concat(e.id, "-right")), (t.sourceCollaps = !0);
              }),
            t
              .filter(function (t) {
                return e.id === t.targetNode;
              })
              .forEach(function (t) {
                (t.target = "".concat(e.id, "-left")), (t.targetCollaps = !0);
              }));
        });
      var n = {},
        i = [];
    ...
    t.diffPropsData = function (e, t) {
      var n = function (e, t) {
          return e.id === t.id;
        },
        i = l.differenceWith(e.nodes, t.nodes, n),
        o = l.differenceWith(t.nodes, e.nodes, n),
        a = function (e, t) {
          return (
            e.sourceNode === t.sourceNode &&
            e.targetNode === t.targetNode &&
            e.source === t.source &&
            e.target === t.target
          );
        },
        r = l.differenceWith(e.edges, t.edges, a),
        s = l.differenceWith(t.edges, e.edges, a),
        d = l.differenceWith(e.nodes, t.nodes, function (e, t) {
          return e.id === t.id && e.isCollapse === t.isCollapse;
        });
      return {
        addNodes: i,
        rmNodes: o,
        addEdges: r,
        rmEdges: s,
        collapseNodes: (d = l.differenceWith(d, i, n)),
      };
    };
    t.updateCanvasData = function (e, t) {
      t.forEach(function (t) {
        var n = l.find(e, function (e) {
          return e.id === t.id;
        });
        l.assign(t.options, n);
      });
    };
    t.diffActionMenuData = function (e, t) {
      var n = function (e, t) {
          return e.key === t.key;
        },
        i = l.differenceWith(e, t, n),
        o = l.differenceWith(t, e, n);
  ...
  470: function (e, t, n) {
    ...
    var _ = (function (e) {
      ...
      function n(e) {
        ...
        return (
          (0, a.default)(this, n),
          ((i = t.call(this, e)).TITLE_HEIGHT = 34),
          (i.ROW_HEIGHT = 26),
          (i.COLUMN_WIDTH = 350),
          (i.fieldsList = []),
          (i.titlesList = []),
          (i._renderPromise = Promise.resolve()),
          (i._isRendering = !1),
          i
        );
      }
        ...
        (0, r.default)(n, [
          {
            key: "mounted",
            value: function () {
              this._createNodeEndpoint(!0),
                (this.width = this.options.width =
                  (0, f.default)(this.dom).width()),
                (this.height = this.options.height =
                  (0, f.default)(this.dom).height());
            },
          },
          {
            key: "draw",
              ...
              var t,
                ...
                a =
                  ...
                  (null === (t = e.options) || void 0 === t
                    ? void 0
                    : t.name) ||
                  (null === (n = e.options) || void 0 === n ? void 0 : n.id);
              o ||
                (o = (0, f.default)("<div></div>")
                  .attr("class", "node table-node")
                  .attr("id", a)),
                o.attr("id", a);
              var r = (0, f.default)(o),
                s = m.get(this, "options.classname");
              return (
                s && r.addClass(s),
                void 0 !== e.top && r.css("top", e.top),
                void 0 !== e.left && r.css("left", e.left),
                this._createTableName(r),
                this._createFields(r),
                (0, h.setElementDragable)(r[0], function (e) {
                  (0, g.getEdges)(a).forEach(function (e) {
                    return e.redraw();
                  }),
                    e(i._canvas);
                }),
          ...
          },
          {
            ...
            value: function (e) {
              var t = this;
              if (e !== this.options.isCollapse) {
                if (((this.options.isCollapse = e), e))
                  this.fieldsList.forEach(function (e) {
                    (0, f.default)(e.dom).off();
                  }),
                    this.endpoints
                      .filter(function (e) {
                        return !e.options._isNodeSelf;
                      })
                      .map(function (e) {
                        return e.id;
                      })
                    ...
                    (0, f.default)(this.dom).find(".field").remove(),
                    (this.fieldsList = []);
                else this._createFields(), this._createNodeEndpoint();
                (this.width = this.options.width =
                  (0, f.default)(this.dom).width()),
                  (this.height = this.options.height =
                    (0, f.default)(this.dom).height());
          ...
          },
          {
            key: "focus",
            value: function () {
              (0, f.default)(this.dom).addClass("focus"),
                (this.options.minimapActive = !0);
            },
          },
          {
            key: "unfocus",
            value: function () {
              (0, f.default)(this.dom).removeClass("focus"),
                (this.options.minimapActive = !1);
            },
          },
          {
            key: "redrawTitle",
            value: function () {
              (0, f.default)(this.dom).find(".operator").remove(),
                this._createTableName((0, f.default)(this.dom), !0);
            },
          },
          {
            ...
            value: function () {
              var e = this;
              (0, f.default)(this.dom).on("mousedown", function (t) {
                0 === t.button &&
                  ([
                    "SELECT",
                    "INPUT",
                    ...
                    "CHECKBOX",
                    "TEXTAREA",
                  ].includes(t.target.nodeName) || t.preventDefault(),
                  e.draggable
                    ? ((e._isMoving = !0),
                      e.emit("InnerEvents", {
                        type: "node:dragBegin",
                ...
                (0, f.default)(this.dom).on("click", function (t) {
                  e.emit("system.node.click", { node: e }),
                    e.emit("events", { type: "node:click", node: e });
                }),
          ...
          },
          {
            ...
            value: function () {
              var e = this,
                t =
                  arguments.length > 0 && void 0 !== arguments[0]
                    ? arguments[0]
                    : (0, f.default)(this.dom),
                n = arguments.length > 1 ? arguments[1] : void 0,
                i = m.get(this, "options.name"),
                o = m.get(this, "options._titleRender"),
                a = m.get(this, "options._operator"),
                r = n
                  ? (0, f.default)(this.dom).find(".title-con")
                  : (0, f.default)('<div class="title-con"></div>'),
                s = n
                  ? (0, f.default)(this.dom).find(".title")
                  : (0, f.default)('<div class="title"></div>');
              if (this._isRendering) return !1;
              o
                ? ((this._isRendering = !0),
                  (this._canvas
                    ? this._canvas._renderPromise
                    : Promise.resolve()
                  ).then(function () {
                    e._renderPromise = new Promise(function (t, n) {
                      u.render(o(i, e), s[0], function () {
                        if (0 === e.height || 0 === e.width)
                          (e.width = e.options.width =
                            (0, f.default)(e.dom).width()),
                            (e.height = e.options.height =
                              (0, f.default)(e.dom).height()),
                            e.endpoints.forEach(function (e) {
                              return e.updatePos();
                            }),
                            e.emit("custom.edge.redraw", { node: e });
                        else {
                          var n = [];
                          e.endpoints.forEach(function (e) {
                            e.options._isNodeSelf && (e.updatePos(), n.push(e));
                          }),
                            e.emit("custom.edge.redraw", {
                              node: e,
                              points: n,
                            });
                        }
              ...
              if (
                (a &&
                  ((l = (0, f.default)('<div class="operator"></div>')),
                  a.forEach(function (t) {
                    var n = (0, f.default)('<div class="operator-item"></div>');
                    u.render(t.icon, n[0]),
                      t.onClick &&
                        n.on("click", t.onClick.bind(e, e.options, e)),
                      l.append(n);
                  }),
                  r.append(l)),
                !n)
              ) {
                var d = (0, f.default)('<div class="point left-point"></div>'),
                  c = (0, f.default)('<div class="point right-point"></div>');
                r.append(d).append(c),
                  (this.titlesList = this.titlesList.concat([
                    {
                      id: "".concat(this.id, "-left"),
                      dom: d[0],
                      type: "target",
                    },
                    {
                      id: "".concat(this.id, "-right"),
                      dom: c[0],
                      type: "source",
                    },
                  ])),
                  (0, f.default)(t).append(r);
              }
            },
          },
          {
              ...
              var e = this,
                t =
                  arguments.length > 0 && void 0 !== arguments[0]
                    ? arguments[0]
                    : (0, f.default)(this.dom),
                n = m.get(this, "options.fields"),
                i = m.get(this, "options._columns"),
                o = m.get(this, "options.isCollapse"),
                a = i[0].key,
                r = [];
              if (n && n.length) {
                if (o) return;
                n.forEach(function (n, o) {
                  var s = (0, f.default)('<div class="field"></div>');
                  s.css({
                    height: e.ROW_HEIGHT + "px",
                    "line-height": e.ROW_HEIGHT + "px",
                  }),
                    i.forEach(function (t) {
                      if (t.render) {
                        var i = (0, f.default)(
                        ...
                        i.css("width", (t.width || e.COLUMN_WIDTH) + "px"),
                          u.render(t.render(n[t.key], n, o), i[0]),
                          s.append(i);
                      } else {
                        var r = (0, f.default)(
                          '<span class="field-item" title="'
                            .concat(n[t.key], '">')
                            .concat(n[t.key], "</span>")
                        );
                        r.css("width", (t.width || e.COLUMN_WIDTH) + "px"),
                          s.append(r);
                      }
                      t.primaryKey && (a = t.key);
                    });
                  var l = (0, f.default)(
                      '<div class="point left-point hidden"></div>'
                    ),
                    d = (0, f.default)(
                      '<div class="point right-point hidden"></div>'
                    );
                  s.append(l).append(d),
                    e.options._enableHoverChain &&
                      ((0, f.default)(s).on("mouseover", function (t) {
                        e.emit("custom.field.hover", {
                          node: e,
                          fieldId: n[a],
                        });
                      }),
                      (0, f.default)(s).on("mouseout", function (t) {
                        e.emit("custom.field.unHover", {
                          node: e,
                          fieldId: n[a],
                        });
                      })),
                  ...
                  (this.fieldsList = this.fieldsList.concat(r));
              } else {
                var s = m.get(this.options, "_emptyContent");
                if (s) {
                  var l = (0, p.default)({
                    content: s,
                    width: this.options._emptyWidth,
                  });
                  t.append(l), (this.height = (0, f.default)(t).outerHeight());
                }
              }
              return r;
            },
          },
          {
            ...
            value: function (e) {
              var t = this;
              e &&
                this.titlesList.forEach(function (e) {
                  t.addEndpoint({
                    id: e.id,
                    orientation: "target" === e.type ? [-1, 0] : [1, 0],
                    dom: e.dom,
                    originId: t.id,
                    type: e.type,
                    _isNodeSelf: !0,
                ...
                this.fieldsList.forEach(function (e) {
                  t.addEndpoint({
                    id: "".concat(e.id, "-left"),
                    orientation: [-1, 0],
                    dom: (0, f.default)(e.dom).find(".left-point")[0],
                    originId: t.id,
                    type: "target",
                  }),
                    t.addEndpoint({
                      ...
                      orientation: [1, 0],
                      dom: (0, f.default)(e.dom).find(".right-point")[0],
                      originId: t.id,
                      type: "source",
                    }),
                    t.options.isCollapse &&
                      (0, f.default)(e.dom).css({
                        visibility: "visible",
                        display: "none",
                      });
                });
  ...
  471: function (e, t, n) {
    ...
    t.default = function (e) {
      var t = e.content,
        n = e.container[0],
        i = e.width;
      i || (i = "150px"), "number" == typeof e.width && (i = e.width + "px");
      var s,
        l = '<div style="width: ' + i + '"></div>';
      if (t)
        (s = t),
          (l = a.default.isValidElement(s)
            ? r.default.render(t, n)
            : (0, o.default)(t));
      else {
        l = (0, o.default)(
          '<div class="no-data" style="width: ' + i + '"></div>'
        );
        var d = (0, o.default)(
          '<i class="no-data-icon table-build-icon table-build-icon-kongshuju"></i>'
        );
        l.append(d);
      }
      return l;
  ...
  472: function (e, t, n) {
    ...
    var h = (function (e) {
      ...
      var t = p(n);
      function n(e) {
        return (0, o.default)(this, n), t.call(this, e);
      }
      return (
        (0, a.default)(n, [
          {
            key: "mounted",
            value: function () {
              this.sourceNode.options.isCollapse ||
                (0, u.default)(this.sourceEndpoint.dom).removeClass("hidden"),
                this.targetNode.options.isCollapse ||
                  (0, u.default)(this.targetEndpoint.dom).removeClass("hidden");
            },
          },
          {
            key: "calcPath",
            ...
            value: function () {
              var e =
                arguments.length > 0 && void 0 !== arguments[0]
                  ? arguments[0]
                  : "hover-chain";
              this.options.relationColor &&
                this.dom &&
                (this.dom.style.stroke = this.options.relationColor),
                (0, u.default)(this.dom).addClass(e),
                (0, u.default)(this.arrowDom).addClass(e),
                (0, u.default)(this.labelDom).addClass(e),
                this.setZIndex(1e3);
            },
          },
          {
            ...
            value: function () {
              var e =
                arguments.length > 0 && void 0 !== arguments[0]
                  ? arguments[0]
                  : "hover-chain";
              (this.dom.style.stroke = "#BFBFBF"),
                (0, u.default)(this.dom).removeClass(e),
                (0, u.default)(this.arrowDom).removeClass(e),
                (0, u.default)(this.labelDom).removeClass(e),
                this.setZIndex(0);
            },
          },
          {
            key: "destroy",
            value: function (e) {
              (0, r.default)((0, d.default)(n.prototype), "destroy", this).call(
                this,
                e
              ),
                this.sourceNode.options.isCollapse ||
                  (0, u.default)(this.sourceEndpoint.dom).addClass("hidden"),
                this.targetNode.options.isCollapse ||
                  (0, u.default)(this.targetEndpoint.dom).addClass("hidden");
            },
          },
        ]),
        n
  ...
  473: function (e, t, n) {
    ...
    function c(e, t, n, i, o) {
      var s = function (e) {
          if (o) {
            for (
              ...
              var i = t(n);
              if ("object" === (0, a.default)(i)) return i.v;
            }
            return e[0];
          }
          return e[0];
      ...
      switch (
        (0 === l || 0 === d
          ? (0 === l &&
              ((c = d >= 0 ? s(["Top", "Left", "Right", "Bottom"]) : c),
              (c = d < 0 ? s(["Bottom", "Left", "Right", "Top"]) : c)),
            0 === d &&
              ((c = l >= 0 ? s(["Right", "Top", "Bottom", "Left"]) : c),
              (c = l < 0 ? s(["Left", "Top", "Bottom", "Right"]) : c)))
          : (c = s(
              l > 0 && d > 0
                ? u > 1
    ...
    var u = function (e, t, n) {
      ...
      f = function (e, t, n, i) {
        var o = u(e, t, i),
          a = u(n, t, i),
          r = new d((e.x + n.x) / 2, (e.y + n.y) / 2);
        return [e, o, a, t.y < r.y ? 1 : 0];
      };
    var m = function (e, t) {
      e.orientation ||
        (e.orientation = c(t.pos[0], t.pos[1], e.pos[0], e.pos[1])),
        t.orientation ||
          (t.orientation = c(e.pos[0], e.pos[1], t.pos[0], t.pos[1]));
      var n = [],
        i = { x: e.pos[0], y: e.pos[1] },
        a = { x: t.pos[0], y: t.pos[1] },
        u = { "-10": s, 10: "Right", "0-1": l, "01": "Bottom" };
      if (
        ((function e(t, n, i, o, a) {
          ...
          var r,
            ...
            f = n.x - o.x,
            m = n.y - o.y;
          t.push(new d(n.x, n.y)),
            f * f < 0.01 && m * m < 0.01
              ? t.push(new d(o.x, o.y))
              : (i === s
                  ? f > 0 && m * m < 0.1 && "Right" === a
                    ? ((r = o), (c = a))
                    : (f < 0
                        ? (r = new d(n.x - 20, n.y))
                        : (m > 0 && "Bottom" === a) || (m < 0 && a === l)
                        ? (r = new d(o.x, n.y))
                        : i === a
                        ? ((u = Math.min(n.x, o.x) - 20), (r = new d(u, n.y)))
                        : (r = new d(n.x - f / 2, n.y)),
                      (c = m > 0 ? l : "Bottom"))
                  : "Right" === i
                  ? f < 0 && m * m < 0.1 && a === s
                    ...
                    : (f > 0
                        ...
                        ? (r = new d(o.x, n.y))
                        : i === a
                        ? ((u = Math.max(n.x, o.x) + 20), (r = new d(u, n.y)))
                        : (r = new d(n.x - f / 2, n.y)),
                      (c = m > 0 ? l : "Bottom"))
                  : "Bottom" === i
                  ? f * f < 0.1 && m < 0 && a === l
                    ...
                    : (m > 0
                        ...
                        ? (r = new d(n.x, o.y))
                        : i === a
                        ? ((u = Math.max(n.y, o.y) + 20), (r = new d(n.x, u)))
                        : (r = new d(n.x, n.y - m / 2)),
                      (c = f > 0 ? s : "Right"))
                  : i === l &&
                    (f * f < 0.1 && m > 0 && "Bottom" === a
                      ? ((r = o), (c = a))
                      : (m < 0
                          ? (r = new d(n.x, n.y - 20))
                          : (f > 0 && "Right" === a) || (f < 0 && a === s)
                          ? (r = new d(n.x, o.y))
                          : i === a
                          ? ((u = Math.min(n.y, o.y) - 20), (r = new d(n.x, u)))
                          : (r = new d(n.x, n.y - m / 2)),
                        (c = f > 0 ? s : "Right"))),
                e(t, r, c, o, a));
        })(n, i, u[e.orientation.join("")], a, u[t.orientation.join("")]),
        n.length < 2)
      )
        return "";
      if (2 === n.length)
      ...
      if ((n.pop(), 4 !== n.length))
        return (function (e) {
          return e
            .reduce(
              function (e, t) {
                return e.push(["L", t.x, t.y].join(" ")), e;
              },
              [["M", e[0].x, e[0].y].join(" ")]
            )
            .join(" ");
      ...
      var p = n,
        ...
        y = h[3];
      if (
        (Math.abs(g.y - y.y) < 30 && (m = Math.abs(g.y - y.y) / 2),
        r.default.first(n).x === r.default.last(n).x ||
          r.default.first(n).y === r.default.last(n).y)
      )
        return [
          "M",
          r.default.first(n).x,
      ...
      r.default.first(n).x > r.default.last(n).x && (n = n.reverse());
      var _ = f(g, v, b, m),
        j = f(v, b, y, m);
      return [
        "M",
  ...
  477: function (e, t, n) {
    ...
    t.default = function (e) {
      ...
      Array.isArray(i) || (i = []);
      for (
        var o = s.cloneDeep(d.actions),
          a = [],
          r = function (e) {
            var t = s.find(o, function (t) {
              return t.key === e.key;
            });
            if (!t) return a.push(e), "continue";
            s.merge(t, e),
              a.push(t),
      ...
      return l.createElement(
        "div",
        { className: "lineage-dag-canvas-action" },
        a.map(function (e) {
          return e.disable
            ? null
            : l.createElement(
                ...
                l.createElement(
                  c.default,
                  { title: e.title },
                  "string" == typeof (n = e.icon)
                    ? l.createElement("i", { className: n })
                    : l.isValidElement(n)
                    ? n
                    : null
                )
  ...
  478: function (e, t, n) {
    ...
    t.actions = [
      ...
      },
      {
        ...
        title: (0, i.t)("center"),
        onClick: function (e) {
          e.focusCenterWithAnimate(void 0, function () {
  ...
  480: function (e, t, n) {
    ...
    t.default = function (e) {
      ...
      return t
        ? r.createElement(
            "span",
            { className: "react-lineage-dag-tooltip" },
            r.createElement(
              "span",
              { className: "react-lineage-dag-title" },
              t
            ),
            n
          )
  ...
  570: function (e, t, n) {
    ...
    var i = n(168),
      o = (function () {
        function e() {}
        return (
          (e.prototype.getRelationColorFunc = function (e, t) {
            return function (n) {
              return e.includes(n) && t.includes(n)
                ? (0, i.t)("relationColor.both")
                : e.includes(n)
                ? (0, i.t)("relationColor.contributed")
                : t.includes(n)
                ? (0, i.t)("relationColor.referenced")
                : void 0;
            };
          }),
          (e.prototype.transfer = function (e) {
            var t = this,
              ...
              i = Object.keys(e),
              o = {};
            (n.tables = i.map(function (t) {
              var n = Object.keys(e[t].columns);
              return (
                (o[e[t].table_name] = e[t]),
                {
                  id: e[t].table_name,
                  name: t,
            ...
            return (
              i.map(function (i) {
                var o = e[i],
                  r = e[i].table_name;
                Object.keys(o.columns).forEach(function (e) {
                  var i = o.columns[e],
                    s = i[0],
                    l = i[1],
                    d = t.getRelationColorFunc(s, l),
                    c = Array.from(new Set(o.columns[e].flat(2))),
                    u = e;
                  c.forEach(function (e) {
                    var t = e.split("."),
                      i = t.pop(),
